...
const GAME_UPGRADES = [
  ...
  { tab:'weapons', name:'Rocket Launcher',           desc:'Fires unguided rockets (X key). Uses 1 weapon slot + 1 upgrade slot. Max 1.',           effect:'rocket_launcher', delta:0,     price:25000, limit:1, usesUpgradeSlot:true,  usesWeaponSlot:true  },
